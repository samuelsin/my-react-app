...
const IndexPage = () => (
  <div>
    ...
    <Section 
    image={required('../images/wallpaper2.jpg')}
    logo={require('../images/logo-react.png')}
    title="React for Designers"
    text="Learn how to build a modern site using React and the most efficient libraries to get your site/product online. Get familiar with components, grid CSS, animation, interaction, dynamic data with Contentful and deploying your site with Netlify."
    />
  </div>
)
